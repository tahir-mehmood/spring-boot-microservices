...
import com.tm.learning.authserver.repository.AuthorizationRepository;
import com.tm.learning.authserver.security.CustomUserPrincipalMixin;
...
//            result = this.authorizationRepository.findByDeviceCodeValue(token);
    ...
    /**
     * Authorizations 엔티티를 OAuth2Authorization 객체로 변환하는 메소드
     *
     * @param entity
     * @return
     */
...
//        }
    ...
    /**
     * OAuth2Authorization 객체를 Authorizations 엔티티로 변환하는 메소드
     *
     * @param authorization
     * @return
     */
